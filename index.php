...
<head>
	...
	<body>
		...
		<section class="jumbotron jumbotron-fluid h-auto">
			<center><div class="container2 border border-dark w-75 h-auto" style="background-color:#90B285;text-align: center;">
				<img src="contact.png" height="90" width="110" >
				<h2>Fill the empty box to add Contacts.</h2>
				<form class="p-4 border border-dark bg-light rounded" method="post" action="index.php">
				<div class="form-row">
				...
				<div class="col-md-4 mb-3">
					...
					<input type="email" name="email" class="form-control" id="validationDefault03" placeholder="Email Address" required>
				</div>
				</div>
				<div class="form-row">
				<div class="col-md-4 mb-3">
					<label for="validationDefault01">Phone Number</label>
					<input type="number" name="phonenumber"class="form-control" id="validationDefault01" placeholder="Phone Number" required>
				</div>
				<div class="col-md-4 mb-3">
				...
				<div class="col-md-4 mb-3">
					...
					<div class="input-group">
					<input type="text" name="muni_city" class="form-control" id="validationDefault01" placeholder="Municipality/City" required>
				</div>
				</div>
				<div class="form-row">
				<div class="col-md-6 mb-3">
					<label for="validationDefault01">Province</label>
					<input type="text" name="province" class="form-control" id="validationDefault01" placeholder="Province" required>
				</div>
				<div class="col-md-3 mb-3">
					<label for="validationDefault02">State</label>
					<input type="text" name="state" class="form-control" id="validationDefault02" placeholder="State" required>
				</div>
				<div class="col-md-3 mb-3">
					<label for="validationDefault03">ZipCode</label>
					<div class="input-group">
					<input type="number" name="zip" class="form-control" id="validationDefault01" placeholder="ZipCode" required>
				</div>
				</div>
				...
				<button class="btn btn-success d-flex " onclick="$('#update_success').fadeOut();$('#firstname').focus()" name="add_contacts" type="submit">Add</button>
