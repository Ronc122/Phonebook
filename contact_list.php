...
<head>
	...
	<body>
		...
		<section class="jumbotron jumbotron-fluid text-dark">
			<div class="container3 w-75 rounded border-dark" style="align-items:center; padding-top: 20px; margin: auto;">
				<center><img src="contact.png" height="90" width="110"></center>
				<h2 style="text-align: center;">List of Contacts</h2>
				<table class="table w-75 table-striped table-hover table-dark" style="align-items: center; margin-right: auto;margin-left: auto;" method="post" action="">
						<thead>
							<tr>
					...
					<tbody class="table-striped bg-light text-dark">
							<?php
								$sql 	= "SELECT firstname, phonenumber,id from contacts ORDER BY firstname ASC";
								...
								if (mysqli_num_rows($result) > 0){
									while($row = mysqli_fetch_assoc($result)){
										...
										echo "<a style='font-size:12px;' href='view.php?id=".$id."'>View</a>&nbsp&nbsp<script type='text/javascript'>
					$('#view_contact').fadeIn();
					...
					window.onclick = function(event) {
						if (event.target == modal) {
							$('#view_contact').fadeOut();
										...
										echo "<a style='color:red; font-size:12px;' href='contact_list.php?delete=".$id."'>Delete</a>&nbsp&nbsp";
										echo "</tr>";
